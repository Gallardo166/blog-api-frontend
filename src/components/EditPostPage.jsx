...
const EditPostPage = function() {
  ...
  const [selectedCategories, setSelectedCategories] = useState(post.categories.map((category => category._id)));
        ...
        <fieldset>
          ...
          {categories.map((category) => (
            <div key={category._id}>
              <input checked={selectedCategories.includes(category._id)} type="checkbox" name="categories" id={category.name} value={category._id} onChange={(e) => handleToggleCheckbox(e)} />
